...
def init_db():
    try:
        ...
        # Create admin user - password generated by app
        cur.execute("""
        ...
        # Create ward users - passwords generated by app
        ward_users = [
    ...
    if request.method == 'POST':
        ...
        if file and file.filename.endswith('.xlsx'):
            try:
                ...
                wards = set()
                count = 0
                # Columns: SL NO=0, WARD NO=1, ID NO=2, DRAIN LOCATION=3
                ...
                # Auto-create user for each ward found in Excel
                for ward in wards:
